            ...
            <div className="contact-box-info">
              <div className="contact-box-text">
                ...
                <ul className="contact-box-ul">
                  <li className="contact-list">Консультації та закази за телефоном: +38(095)809-52-79</li>
                  <li className="contact-list">Напишіть нам на пошту або в месенжер: Viber, Telegram, Whats Up.</li>
                  <li className="contact-list"> Email: rctoysua@gmail.com </li>
              ...
              <div className="contact-box-social">
                <ul className="contact-ul-social">
                  ...
                  <li className="contact-social-list"> <a href="https://t.me/RcToysUa" target="_blank" rel="noreferrer"><span className='contact-social-list-img'><img src="./img/contact-img/telegram.png" alt="" /></span> Telegram: RcToysUa</a> </li>
